...
class InvestmentAssumptions {
  ...
  constructor(options = {}) {
    ...
    this.propertyManagementRate = options.propertyManagementRate ?? defaults.propertyManagementRate;
  ...
  update(options) {
    ...
    if (options.propertyManagementRate !== undefined) this.propertyManagementRate = options.propertyManagementRate;
   ...
   * @returns {InvestmentAssumptions} New InvestmentAssumptions instance
   */
